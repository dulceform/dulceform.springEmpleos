...
import org.dulce.curiel.util.Utileria;
...
public class VacantesController {
	...
	//implementacion del data binding (Vinculacion entre clase modelo y formulario)
	@PostMapping("/guardar")
	...
	public String guardar(@RequestParam("nombre") String nombre, 
		...
		//guardar en la tabla correspondiente o en la memoria(lista enlazada)
	...
	public String eliminar(@RequestParam("id") int idVacante,RedirectAttributes attributes) {
		//System.out.println("IdVacante = " + idVacante);
		attributes.addFlashAttribute("msg2", "Vacante eliminada");
		serviceVacantes.eliminar(idVacante);
		return "redirect:/vacantes/index";
	}
	
	/*
	 * Datos comunes en metodos que formen parte del controlador
	 * 
	 */
	@ModelAttribute
